...
class MTableAutoloadMixin extends MBaseMixin {
  VERSION = "2.5.0";
...
class MtdAutoloadMixin extends MBaseMixin {
    toSVG(HW,D) {
...
MathJax.Hub.Register.StartupHook("EditableSVG Jax Ready",function () {
  MathJax.ElementJax.mml.mtable.Augment(MTableAutoloadMixin.getMethods(this));
  MathJax.ElementJax.mml.mtd.Augment(MtdAutoloadMixin.getMethods(this));

  MathJax.Hub.Startup.signal.Post("EditableSVG mtable Ready");
  MathJax.Ajax.loadComplete(MathJax.OutputJax.EditableSVG.autoloadDir + "/mtable.js");
});
